  ...
  function phoneInit() {
    ...
    if (ua.configuration.uri.host === tryit_sip_domain) {
      ...
      $("#call-invitation > a").balloon({
        position: "bottom",
        contents: "<p>copy and give the following link to others (via e-mail, chat, fax):</p><a href='https://tryit.jssip.net/js/&quot;&#32;+&#32;invitation_link&#32;+&#32;&quot;' target='_blank'>" + invitation_link + "</a>",
